...
$dni = 0;
  ...
  //   $codigo_verificacion1=$_POST['codigo_verificacion'];
...
if ($repeat == 0) {
    if ($email != "") {
            //////////////////////////////////////// insert
        $sql = "INSERT INTO $datos_personales(nombre, apellido, email,presupuesto, dni,  fecha_registro, confirmacion, darse_baja)VALUES ('$nombre','$apellido','$email','$presupuesto','$dni','$fecha_registro','$confirmacion','$darse_baja')";
...
.head-main{
	text-shadow: -<?= $stroke2 ?> 0 <?= $sombra ?> <?= $borde ?>, 0 <?= $stroke2 ?> <?= $sombra ?> <?= $borde ?>, <?= $stroke2 ?> 0 <?= $sombra ?> <?= $borde ?>, 0 -<?= $stroke2 ?> <?= $sombra ?> <?= $borde ?>;
}
...
<!-- //////////////////////////////////////////////// -->    
<div class="dl">
<div id="flotante" style="display:;">
<!-- <form role="form"  name="formulario"  id="formulario" onSubmit="return false;" >
    <div class="row setup-content" id="step-1">
            ...
            <h4 class="text-center">¿Con qué frecuencia sueles comprar online?</h4>
            <div class="descr">           
                    <div class="form-group"> 
                     <label class="btn btn-default">
                         <a class="nextBtn"><input type="radio" name="pregunta1" value="Muy frecuentemente">
                         <span>Muy frecuentemente</span></a>
                     </label>
                    </div>
                    <div class="form-group"> 
                     <label class="btn btn-default">
                         <a class="nextBtn"><input type="radio" name="pregunta1" value="Ocasionalmente">
                         <span>Ocasionalmente</span></a>
                     </label>
                    </div>
                    <div class="form-group"> 
                     <label class="btn btn-default">
                         <a class="nextBtn"><input type="radio" name="pregunta1" value="Raramente">
                         <span>Raramente</span></a>
                     </label>
                     </div>
                    <div class="form-group"> 
                     <label class="btn btn-default">
                         <a class="nextBtn"><input type="radio" name="pregunta1" value="No suelo Comprar Online">
                         <span>No suelo Comprar Online</span></a>
                     </label>
    ...
    <div class="row setup-content" id="step-2">
            ...
            <h4 class="text-center">¿Cuál de los siguientes factores es el más importante para ti al comprar?</h4>
            <div class="descr">           
                    <div class="form-group"> 
                     <label class="btn btn-default">
                         <a class="nextBtn"><input type="radio" name="pregunta2" value="Calidad">
                         <span>Calidad</span></a>
                     </label>
                    </div>
                    <div class="form-group"> 
                     <label class="btn btn-default">
                         <a class="nextBtn"><input type="radio" name="pregunta2" value="Precio">
                         <span>Precio</span></a>
                     </label>
                    </div>
                    <div class="form-group"> 
                     <label class="btn btn-default">
                         <a class="nextBtn"><input type="radio" name="pregunta2" value="Envío rápido">
                         <span>Envío rápido</span></a>
                     </label>
                     </div>
                    <div class="form-group"> 
                     <label class="btn btn-default">
                         <a class="nextBtn"><input type="radio" name="pregunta2" value="Variedad de productos">
                         <span>Variedad de productos</span></a>
                     </label>
                     </div>                     
            </div>    
    </div>
    <div class="row setup-content" id="step-3">
            ...
            <h4 class="text-center">¿Cuántos hijos tienes?</h4>
            <div class="descr">           
                    <div class="form-group"> 
                     <label class="btn btn-default">
                         <a class="nextBtn"><input type="radio" name="pregunta3" value="1 - 2">
                         <span>1 - 2</span></a>
                     </label>
                    </div>
                    <div class="form-group"> 
                     <label class="btn btn-default">
                         <a class="nextBtn"><input type="radio" name="pregunta3" value="3 - 4">
                         <span>3 - 4</span></a>
                     </label>
                    </div>
                    <div class="form-group"> 
                     <label class="btn btn-default">
                         <a class="nextBtn"><input type="radio" name="pregunta3" value="4 o más">
                         <span>4 o más</span></a>
                     </label>
                     </div>
                    <div class="form-group"> 
                     <label class="btn btn-default">
                         <a class="nextBtn"><input type="radio" name="pregunta3" value="Ninguno">
                         <span>Ninguno</span></a>
                     </label>
                     </div>                     
            </div>    
    ...
    <div class="row setup-content" id="step-4">
            ...
            <h4 class="text-center">¿Cuál es tu situación actual?</h4>
            <div class="descr">           
                    <div class="form-group"> 
                         <input class="opbutton" name="pregunta41" type="button" value ="Vivienda propia" onclick="javascript:cerrar(); enviarDatos('Vivienda propia');">
                    </div>
                    <div class="form-group">
                         <input class="opbutton" name="pregunta42" type="button" value ="Vivienda Hipotecada" onclick="javascript:cerrar(); enviarDatos('Vivienda Hipotecada');">
                    </div>
                    <div class="form-group"> 
                         <input class="opbutton" name="pregunta43" type="button" value ="Vivienda Alquilada" onclick="javascript:cerrar(); enviarDatos('Vivienda Alquilada');">
                     </div>
                    <div class="form-group">
                         <input class="opbutton" name="pregunta44" type="button" value ="Casa propia y de vacaciones" onclick="javascript:cerrar(); enviarDatos('Casa propia y de vacaciones');">
                     </div>                     
            </div>    
    </div>     
</form> -->
...
if ($repeat != '1') {
    echo '
            <div class="discount alizarin">                
                <div class="type" id="hola">
                    Gracias por tu participación
                </div>
            </div><br><br>
            <p style="font-size:15px;color:#000">!FELICIDADES ' . $nombre . ' ' . $apellido . '!<br>

            Te acabamos de enviar un mail con un enlace, haz clic en él para confirmar tu participación.</p>
            <div><br><br><br><br></div>
            <div><br><br><br><br></div>
            <div><a href="../"><button type="button" class="opbutton" value="Regresar">REGRESAR</button></a></div>';
} else {
    echo '
            <div class="discount alizarin">                
                <div class="type">
            ...
            <p style="font-size:15px;color:#000">¡Solo puedes participar una vez!</p>
            <div><br><br><br><br></div>
            <div><br><br><br><br></div>            
            <div><a href="../"><button type="button" class="opbutton" value="Regresar">REGRESAR</button></a></div>';
}
...
function enviarDatos(RespPregunta4){
  ...
  pregunta4=RespPregunta4;
  dni1=document.formulario.dni1.value;
  nombre1=document.formulario.nombre1.value;
  ...
  ajax.send("pregunta1="+pregunta1+"&pregunta2="+pregunta2+"&pregunta3="+pregunta3+"&pregunta4="+pregunta4+"&dni1="+dni1+"&nombre1="+nombre1+"&email1="+email1)
} 
//función para limpiar los campos
function LimpiarCampos(){
  document.ejemplo.variable.value="";  
  document.ejemplo.variable.focus();
}
