...
sort($rows);
	foreach ($rows as $valor) {
		...
		$recaptcha_sitekey = $valor['recaptcha_sitekey'];
	}
?>
<!DOCTYPE html>
<html lang="en">
...
$email_desencriptar2 = encriptar("$d");
...
?>
<body  id="bodyCB" background="#ebebeb">
	<header id="fondo" >
    <div class="container">
      <div class="logo"> 
        <h1 class="lighter wow bounceInDown" data-wow-duration="1s" data-wow-delay="0.1s"><font ><span class="head-main">Gana un </span> <span class="head-main2" style="color: rgb(249, 77, 254);">Cocurso </span> <br><span class="head-main"></span></font>
        </h1> 
            </div>
    </div> 
  </header>
...
<br><br><br> 
     <div class="descr col-md-3"></div> 
     <div class="dl col-md-6" style="background-color: rgb(226, 186, 99)">  
     <div id="flotante" style="display:;">                  
      <form role="form" action="guardar.php" name="formulario"  onsubmit="return miFuncion(this)" method="POST">
          <div>
              <div> 
              <?php 
              if($r==NULL AND $repeat==1) 
              echo'
                    ...
                    <h4 class="text-center">Si no deseas recibir más promociones de CONCURSOMANIA.COM, puedes darte de baja aquí</h4>
                    
                    <div class="descr ">
                       <div class="form-group">
                        <input maxlength="100" type="text" name="email" required class="form-control" placeholder="E-mail" pattern="^[a-zA-Z0-9.!#$%&*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$" onblur="validaemail(fr.email)" /><p ></p>
                        <input type="hidden" name="email_desencriptar" value="'.$email_desencriptar.'">
                        <input type="hidden" name="codigo_verificacion" value="'.$codigo_verificacion.'">
                       </div>                               
                      <div class="g-recaptcha" data-sitekey="'.$recaptcha_sitekey.'"></div>

                    </div> 
                          <div class="form-group">
                              <button class="opbutton" type="submit">Darse de baja</button>                                    
                          </div> 
              ';
                         ///////////////////////////////////<div class="g-recaptcha" data-sitekey="6LfcrzoUAAAAAAR8b_u9ykX4TmEN4uVuZYIqZ5MY"></div>/      
       if($r=="000000001")
    {
            echo'
            <div class="discount alizarin">                
            ...
            <div><br><br><br><br></div>
            <h4> ¡Se ha dado de baja correctamente, la cancelación de sus datos se hará efectiva en 24 horas! <br> ¡Gracias por haber estado con nosotros! <br> ¡Vuelve cuando quieras!</h4>
            <div><br><br><br><br></div>
            <div><br><br><br><br></div>';
     } 
     if($r=="000000000")
...
<!--//FIN BLOQUE COOKIES-->
   <!-- Condiciones del Sorteo data-sitekey -->
...
function enviarDatos(){
  ...
  dni_desencriptar=document.formulario.dni_desencriptar.value;
  email=document.formulario.email.value;
  codigo_verificacion=document.formulario.codigo_verificacion.value;
  ...
  ajax.send("&codigo_verificacion="+codigo_verificacion+"&email="+email)
} 
...
nombre.onkeyup = apellido.onkeyup = email.onkeyup = activarBoton;
